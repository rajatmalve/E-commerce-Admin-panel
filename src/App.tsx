...
function App() {
  ...
  const renderPage = () => {
    switch (currentPage) {
      case 'dashboard':
        return <Dashboard searchTerm={searchTerm} onNavigateToPage={handleNavigateToPage} />;
      case 'category':
        return <CategoriesTab searchTerm={searchTerm} />;
      case 'products':
      ...
      case 'coupons':
        return <Coupons searchTerm={searchTerm} />;
      case 'inventory':
